      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/campus bulding.jpg"> </a>
                  <div class="media-body"> <a href="https://www.dspmuranchi.ac.in/"target="_blank" class="catg_title"> Dr.Shyama Prasad MUkhrjee University, Ranchi-834005</a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/m3.jpg"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> Mail Us - dspmu@gmail.com</a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/call3.png"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> Call Us - +91 8935997843</a> </div>
                </div>
              </li>
